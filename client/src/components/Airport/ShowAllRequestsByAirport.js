...
rows.push(createData('Насосы', 'Aeroflot', 'SU1117', "В рассмотрении", "-", 237));
rows.push(createData('Устройства воздушного запуска', 'UTair', 'UT400', "Отказано", "-", 262));
rows.push(createData('Трапы', 'Rusline', '7R136', "Выполнено", "Выполнено", 305));
//-----------------------------------------------------------
