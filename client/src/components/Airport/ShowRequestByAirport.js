...
export default function ShowRequestByAirport() {
  ...
  return (
    <Paper className={classes.paper}>
      ...
      <form className={classes.root} noValidate autoComplete="off">
        ...
        <br></br>
        <TextField className={classes.comment} id="outlined-basic" InputProps={{readOnly: true}} label="Статус запроса в авиакомпании" value="Одобрено" multiline variant="outlined" />
        <br></br>
        <FormControl variant="outlined" className={classes.formControl}>
            <InputLabel id="demo-simple-select-outlined-label">Статус запроса в аэропорту</InputLabel>
            <Select
        ...
        <br></br>
        <TextField className={classes.comment} id="outlined-basic" label="Комментарий аэропорта" multiline variant="outlined" />
      </form>
